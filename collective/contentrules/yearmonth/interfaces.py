...
class ITargetFolder(Interface):
    """ 
       ...
       The administratore choose a target root folder but contents won't be
       ...
       This should adapt the content to be moved and the content rule action IMoveAction
       defined in this package. 
    """

    def setup_target():
        """ Creates if needed and returns the target folder into the target root folder """ 
